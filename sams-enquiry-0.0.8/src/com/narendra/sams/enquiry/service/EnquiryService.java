...
public interface EnquiryService {
    ...
    List<StatusWiseEnquiryCount> getStatusWiseEnquiryCount(Long l, Long l2);

    Boolean isEnquiriesExists(Collection<Long> collection);

    Boolean isEnquiryExist(Long l, Long l2, String str, String str2);

    void updateEnquiry(Enquiry enquiry, Long l);

    void updateNewEnquiry(Enquiry enquiry, Long l);
}
