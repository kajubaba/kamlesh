...
public interface AcademicYearFeeService {
    ...
    AcademicYearFee getAcademicYearFeeForNewAdmissions(Long l);

    AcademicYearFee getAcademicYearFeeForRegularAdmissions(Long l);
