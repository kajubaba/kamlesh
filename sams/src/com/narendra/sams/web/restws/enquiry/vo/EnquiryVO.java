...
public class EnquiryVO {
    ...
    private String formIssuedOn;
    private String formNo;
    private Long formReceiptNo;
    ...
    public String getFormIssuedOn() {
        return this.formIssuedOn;
    }

    public void setFormIssuedOn(String formIssuedOn) {
        this.formIssuedOn = formIssuedOn;
    }

    public Long getFormReceiptNo() {
        return this.formReceiptNo;
    }

    public void setFormReceiptNo(Long formReceiptNo) {
        this.formReceiptNo = formReceiptNo;
    }
