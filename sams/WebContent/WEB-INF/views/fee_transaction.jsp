...
<div id="content_area">
	<div id="wider_working_area" class="color_theme_border">
		...
		<div class="working_area_spacer">
			...
			<div id="printRecieptDiv">
			<div class="feeRecieptDuplicate">	
					...
					<table class="recieptWidth" padding="2px">
						<tr>
							<td style="float: right;padding-right: ">Receipt No : ${feeTransaction.recieptNo}</td>
						</tr>
						<tr>
						...
						&nbsp;&nbsp;${feeTransaction.student.fatherName}
							</td>
						</tr>
						<tr>
							<td>
					...
					<table class="recieptWidth" style="border: 1px solid; margin-top: 10px;" >
						<tr style="border-bottom: 1px solid;">
							...
							<c:forEach var="printFeeTransactionDetail" items="${feeTransaction.feeTransactionDetails}" varStatus="rowCounter">
								<tr>
