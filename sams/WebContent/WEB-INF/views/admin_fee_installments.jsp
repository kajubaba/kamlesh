...
<div class="page_title"><span class="page_title_text">Manage Installments</span></div>
	...
	<div class="form_container">
		<div>
			<table>
				<tr>
					<td>Academic Year : </td>
					<td> ${courseYearSetting.academicYear.name} </td>
				</tr>
				<tr>
					<td>Class : </td>
					<td> ${courseYearSetting.courseYear.course.displayName}, ${courseYearSetting.courseYear.name} Year (${courseYearSetting.courseYear.course.affiliatedTo.displayName})</td>
				</tr>
			</table>
		</div>
	</div>	
...
<input type="hidden" id="admissionType" value="${admissionType}"/>
<input type="hidden" id="courseYearSettingId" value="${courseYearSetting.id}"/>
...
<div id="manage-installment-container">
	...
	<div style="margin-bottom: 10px; text-align: center;width: 100%">
						Installment(s) : 
			<select id="feeInstallments" style="width: 200px;" onchange="changeInstallments(this)">
...
<input type="hidden" name="academicYearFeeId" value="${academicYearFee.id}" />
