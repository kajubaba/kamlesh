...
samsApp.controller('affiliationauthority.list.controller', function(affiliationAuthorityService, serverErrorHandlerService, $scope, $route, $rootScope, $location, $routeParams, blockUI){
