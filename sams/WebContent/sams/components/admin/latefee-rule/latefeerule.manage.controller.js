...
samsApp.controller('latefeerule.manage.controller', function(affiliationAuthorityService, serverErrorHandlerService, $scope, $route, $rootScope, $location, $routeParams, $timeout, blockUI){
